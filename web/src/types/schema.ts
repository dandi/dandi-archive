 ...
 * DO NOT MODIFY IT BY HAND. All changes should be made through the "npm run migrate" command.
 * TypeScript typings for dandiset metadata are based on schema v0.6.10 (https://raw.githubusercontent.com/dandi/schema/master/releases/0.6.10/dandiset.json)
 */
 ...
 */
export type UseLastFirstExampleLovelaceAugustaAda = string;
 ...
 * Dates of diagnosis
 */
export type DatesOfDiagnosis = string[];
/**
 * Uniform resource identifier
 */
...
/**
 * Any acknowledgments not covered by contributors or external resources.
 */
...
export interface Person {
  ...
  name: UseLastFirstExampleLovelaceAugustaAda;
  email?: Email;
  url?: URL;
  roleName?: Role;
