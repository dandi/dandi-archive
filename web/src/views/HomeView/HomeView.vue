<template>
  <v-container fluid class="pa-0">
    <v-row>
      <v-img :src="logo" class="grey lighten-5" position="left" max-height="500px" contain>
        <v-container
          fluid
          ...
          <v-row class="flex-grow-1" justify="center" align="center">
            <v-col class="splash-text my-12">
              ...
              <div class="text-h6 font-weight-light text-center">
                The BRAIN Initiative archive for publishing and sharing neurophysiology data
                including electrophysiology, optophysiology, and behavioral time-series, and images
