...
from dandiapi.api.models.dandiset import DandiPermissions, DandisetStar
...
class DandisetViewSet(ReadOnlyModelViewSet):
    ...
    def require_perm(self, dandiset: Dandiset, perm: DandiPermissions):
    ...
    def get_object(self):
        ...
        if dandiset.embargo_status != Dandiset.EmbargoStatus.OPEN:
            self.require_perm(dandiset, DandiPermissions.VIEW_DANDISET)
    ...
    def users(self, request, dandiset__pk):
        ...
        if request.method == 'PUT':
            ...
            self.require_perm(dandiset, DandiPermissions.UPDATE_DANDISET_ROLES)
    ...
    def uploads(self, request, dandiset__pk):
        ...
        self.require_perm(dandiset, DandiPermissions.MANAGE_DANDISET_UPLOADS)
