...
class DandisetQueryParameterSerializer(serializers.Serializer):
    ...
    search = serializers.CharField(
        ...
        help_text=(
            ...
            'contributor (matches a contributor by name, email, or identifier '
            '— ORCID for Persons, ROR URL for Organizations; any role); '
            'plus one operator per dandi-schema RoleType for filtering by '
            'role: author, contact_person, data_curator, funder, maintainer, '
            'project_leader, sponsor, conceptualization, data_collector, '
            'data_manager, formal_analysis, funding_acquisition, '
            ...
            'study_participant — each matches a contributor by '
            'name/email/identifier AND requires that '
