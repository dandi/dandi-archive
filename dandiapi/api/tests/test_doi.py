...
def test_generate_doi_data_url_handling_version_doi(published_version):
    ...
    _, datacite_payload = datacite.generate_doi_data(version=published_version, version_doi=True)
...
def test_generate_doi_data_url_handling_dandiset_doi(published_version):
    ...
    _, datacite_payload = datacite.generate_doi_data(version=published_version, version_doi=False)
