...
def test_asset_unembargo(
    storage, asset_factory, embargoed_asset_blob_factory, draft_version, monkeypatch
):
    ...
    embargoed_etag = embargoed_asset.blob.etag
    assert embargoed_asset.blob is not None
    assert embargoed_asset.blob.embargoed
    ...
    assert not asset.blob.embargoed
