...
class ZarrChecksumUpdater:
    ...
    _default_file_updater_cls = ZarrChecksumFileUpdater

    def __init__(
        self,
        zarr_archive: ZarrArchive | EmbargoedZarrArchive,
        file_updater=_default_file_updater_cls,
    ) -> None:
        self.zarr_archive = zarr_archive
        self._file_updater_cls: ZarrChecksumFileUpdater = file_updater
    ...
    def modify(self, modifications: ZarrChecksumModificationQueue):
        while not modifications.empty:
            ...
            with self._file_updater_cls(self.zarr_archive, modification.path) as file_updater:
