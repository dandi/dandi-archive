...
@click.option(
    "--id",
    type=click.IntRange(1, 999999),
    required=False,
    help="The ID of the development Dandiset. The next sequence ID will be used if omitted.",
)
def create_dev_dandiset(*, name: str, email: str, id: int | None = None):
