...
3. Navigate to `localhost:8000/admin`, and log in with the username and password.  Under the `User` section, select the username and change the `Status` from `Incomplete` to `Approved`.
