 ...
 * TypeScript typings for dandiset metadata are based on schema v0.5.1 (https://raw.githubusercontent.com/dandi/schema/master/releases/0.5.1/dandiset.json)
 */
 ...
 */
export type LicenseType = "spdx:CC0-1.0" | "spdx:CC-BY-4.0" | "spdx:CC-BY-NC-4.0";
/**
